                ...
                {roleOptions.map(option => (
                  <FormItem key={option.value}>
                    ...
                    <Label
                      ...
                      className="border-muted bg-background peer-data-[state=checked]:border-primary [&:has([data-state=checked])]:border-primary flex cursor-pointer flex-col rounded-md border-2 px-4 py-2"
                    >
