...
// import useSmoothDragToScroll from '@/hooks/use-smooth-drag-to-scroll';
      ...
      <div className="relative mt-3 flex h-full grow flex-col">
        ...
        <div ref={containerRef} className="scrollbar overflow-auto rounded border">
          <Table className={classNames(tableClassName)}>
            <TableHeader className="bg-card after:bg-border after:absolute after:bottom-0 after:h-[1px] after:w-full after:content-['']">
